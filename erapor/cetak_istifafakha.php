...
<body>
    ...
    <div class="no-print" style="margin-bottom: 20px; text-align: right;">
        <a href="output.php"
            style="padding: 8px 15px; background: #6c757d; color: white; text-decoration: none; border-radius: 4px;">Kembali</a>

        <a href="cetak.php?nis=<?= $nis ?>&smt=<?= $smt ?>&tp=<?= $tp ?>"
            style="padding: 8px 15px; background: #e74c3c; color: white; text-decoration: none; border-radius: 4px; font-weight: bold;">Download PDF
        </a>
    </div>
